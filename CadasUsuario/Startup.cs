...
namespace CadasUsuario
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IClienteRepository, ClienteService>();
            services.AddScoped<ICadastroCliente, CadastroService>();
            ...
            {
                cfg.CreateMap<Cliente, DadosCliente>();
                cfg.CreateMap<DadosCliente, Cliente>();
                }
            );
